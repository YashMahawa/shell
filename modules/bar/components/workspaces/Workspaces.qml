...
StyledClippingRect {
    ...
    implicitWidth: isVertical ? Tokens.sizes.bar.innerWidth : layout.implicitWidth + Tokens.padding.small
    implicitHeight: isVertical ? layout.implicitHeight + Tokens.padding.small : Tokens.sizes.bar.innerWidth

        ...
        Item {
            ...
            Component {
                ...
                MaterialIcon {
                    animate: true
                    text: {
                        if (root.lock.pam.fprint.tries >= GlobalConfig.lock.maxFprintTries || root.lock.pam.fprintState === "max")
                            return "fingerprint_off";
                        if (root.lock.pam.fprint.active)
                            return "fingerprint";
                        return "lock";
                    }
                    color: (root.lock.pam.fprint.tries >= GlobalConfig.lock.maxFprintTries || root.lock.pam.fprintState === "max") ? Colours.palette.m3error : Colours.palette.m3onSurfaceVariant

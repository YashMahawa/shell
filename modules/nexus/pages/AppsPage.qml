...
PageBase {
    ...
    readonly property int popupWidth: Number.isFinite(Tokens.sizes.nexus.popupWidth) ? Tokens.sizes.nexus.popupWidth : 300
    readonly property int minPopupHeight: Number.isFinite(Tokens.sizes.nexus.minPopupHeight) ? Tokens.sizes.nexus.minPopupHeight : 200
    readonly property int maxPopupHeight: Number.isFinite(Tokens.sizes.nexus.maxPopupHeight) ? Tokens.sizes.nexus.maxPopupHeight : 800
    ...
    component DefaultRow: PopupRow {
        ...
        popup.topMovement: Math.max(root.minPopupHeight - popupHeight, Tokens.padding.large)
        ...
        Loader {
            ...
            sourceComponent: VerticalFadeListView {
                ...
                implicitHeight: CUtils.clamp(row.popupHeight, root.minPopupHeight, root.maxPopupHeight)
